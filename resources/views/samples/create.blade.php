                    ...
                    <div class="form-group">
                        ...
                        <div
                            x-data="clientSearch({
                                ...
                                initialId: @js(old('client_id', $selectedClient->id ?? '')),
                                initialText: @js(old('client_text', isset($selectedClient) ? (($selectedClient->company_name ?: trim($selectedClient->first_name . ' ' . $selectedClient->last_name)) . ($selectedClient->tax_code ? ' ('.$selectedClient->tax_code.')' : '')) : ''))
                            })"
                            @client-created.window="selectClient($event.detail)"
                            class="client-search"
                ...
                async submitClient(event) {
                    ...
                    try {
                        ...
                        if (response.ok && result.success) {
                            // Invia evento al componente di ricerca live
