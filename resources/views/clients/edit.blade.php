...
@section('breadcrumb')
    ...
    <a href="{{ route('clients.show', $client) }}" class="breadcrumb-item">{{ $client->company_name ?: $client->first_name . ' ' . $client->last_name }}</a>
    <span class="breadcrumb-separator">/</span>
    <span class="breadcrumb-item active">Modifica</span>
@endsection

@section('content')
<div class="form-card-wrap" x-data="{ type: '{{ old('type', $client->type) }}' }">
    <div class="form-card-header" style="display:flex;align-items:center;justify-content:space-between;">
        <h2 class="form-card-title">Modifica Cliente</h2>
    ...
    <div class="form-card-body">
        <form action="{{ route('clients.update', $client) }}" method="POST">
                    ...
                    <div class="form-grid-3" style="grid-template-columns: 2fr 1fr;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="province" id="province" class="form-control"
                                value="{{ old('province', $client->province) }}" maxlength="5">
                        </div>
                    </div>
                    <div class="form-grid-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="postal_code" id="postal_code" class="form-control"
                                value="{{ old('postal_code', $client->postal_code) }}" maxlength="10">
                        </div>
                        <div class="form-group">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tax_code" id="tax_code" class="form-control"
                            value="{{ old('tax_code', $client->tax_code) }}" style="text-transform:uppercase">
                    </div>
                    ...
                    <div class="form-group" x-show="type === 'company'">
                        ...
                        <input type="text" name="sdi_code" id="sdi_code" class="form-control"
                            value="{{ old('sdi_code', $client->sdi_code) }}" maxlength="7" style="text-transform:uppercase">
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions">
                <a href="{{ route('clients.show', $client) }}" class="btn btn-secondary">Annulla</a>
